...
# 5) Packing and Unpacking Large Integers from Bytes, line 18
# 6)
# 7)
# 8) Calculating with Fractions, line 139
# 9) Calculating with Large Numerical Arrays, line 197
# 10)
# 11) Picking Things at Random, line 400
...
# You want to pick random items of a sequence or generate random numbers.
...
# To take a sampling of N items where selected items are removed from
# further consideration, use random.sample() instead:
...
# algorithm. This is a deterministic algorithm, but you can alter the
...
# random.uniform() computes uniformly distributed numbers, and
# random.gauss() computes normally distributed numbers. Consult the
# documentation for information on other supported distributions.

# Functions in random() should not be used in programs related to
# cryptography. If you need such functionality, consider using functions
# in the ssl module instead. For example, ssl.RAND_bytes() can be used to
